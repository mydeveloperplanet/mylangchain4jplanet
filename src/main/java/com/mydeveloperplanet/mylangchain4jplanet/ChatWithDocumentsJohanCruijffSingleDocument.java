...
public class ChatWithDocumentsJohanCruijffSingleDocument {
    ...
    private static Path toPath(String fileName) {
        try {
            URL fileUrl = ChatWithDocumentsJohanCruijffSingleDocument.class.getClassLoader().getResource(fileName);
