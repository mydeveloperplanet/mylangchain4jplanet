...
public class ChatWithDocumentsBruceSpringsteenQ3WithAllGreetingsPositions {
    ...
    private static Path toPath(String fileName) {
        try {
            URL fileUrl = ChatWithDocumentsBruceSpringsteenQ3WithAllGreetingsPositions.class.getClassLoader().getResource(fileName);
